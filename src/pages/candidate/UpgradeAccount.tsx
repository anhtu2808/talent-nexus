    ...
    const plans = [
        {
            ...
            features: [
                ...
                { name: "Upload 1 CV", included: true },
                { name: "3 Free ATS Scans", included: true },
                { name: "1 Free Match Analysis", included: true },
                { name: "2 Free Fix Credits", included: true },
        ...
        },
        {
            ...
            features: [
                { name: "Apply to Jobs", included: true },
                { name: "Upload up to 5 CVs", included: true },
                { name: "Unlimited ATS Scans", included: true },
                { name: "Unlimited Match Analysis", included: true },
                { name: "100 Fix Credits / Month", included: true },
                { name: "Basic Job Search", included: true },
            ],
            action: "Upgrade Now",
